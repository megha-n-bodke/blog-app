...
RSpec.describe User, type: :system do
    ...
    describe 'index page' do
        ...
        it "when i click on a user's name, it redirects me to that user's profile page." do
            User.delete_all
            user = User.create(name: 'John', posts_counter: 30, photo: 'https://randomuser.me/api/port', bio: 'Teacher from Poland.')
            visit users_path
        end
    end
    ...
    describe 'show page' do
        ...
        it 'I can see the user\'s posts.' do
            post = Post.create(author_id: subject.id, title: 'First Post', text: 'My first post', comments_counter: 20, likes_counter: 30)
            visit user_path(subject.id)
